...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha com.footballpredictions.covidappkenya:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.footballpredictions.covidappkenya:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #CoordinatorLayout_keylines com.footballpredictions.covidappkenya:keylines}</code></td><td>A reference to an array of integers representing the
     * locations of horizontal keylines in dp from the starting edge.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_statusBarBackground com.footballpredictions.covidappkenya:statusBarBackground}</code></td><td>Drawable to display behind the status bar when the view is set to draw behind it.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.footballpredictions.covidappkenya:keylines
     */
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name com.footballpredictions.covidappkenya:statusBarBackground
     */
     ...
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchor com.footballpredictions.covidappkenya:layout_anchor}</code></td><td>The id of an anchor view that this view should position relative to.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchorGravity com.footballpredictions.covidappkenya:layout_anchorGravity}</code></td><td>Specifies how an object should position relative to an anchor, on both the X and Y axes,
     * within its parent's bounds.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_behavior com.footballpredictions.covidappkenya:layout_behavior}</code></td><td>The class name of a Behavior class defining special runtime behavior
     * for this child view.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_dodgeInsetEdges com.footballpredictions.covidappkenya:layout_dodgeInsetEdges}</code></td><td>Specifies how this view dodges the inset edges of the CoordinatorLayout.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_insetEdge com.footballpredictions.covidappkenya:layout_insetEdge}</code></td><td>Specifies how this view insets the CoordinatorLayout and make some other views
     * dodge it.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_keyline com.footballpredictions.covidappkenya:layout_keyline}</code></td><td>The index of a keyline this view should position relative to.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.footballpredictions.covidappkenya:layout_anchor
     */
     ...
     * </table>
     *
     * @attr name com.footballpredictions.covidappkenya:layout_anchorGravity
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.footballpredictions.covidappkenya:layout_behavior
     */
     ...
     * </table>
     *
     * @attr name com.footballpredictions.covidappkenya:layout_dodgeInsetEdges
     */
     ...
     * </table>
     *
     * @attr name com.footballpredictions.covidappkenya:layout_insetEdge
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.footballpredictions.covidappkenya:layout_keyline
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority com.footballpredictions.covidappkenya:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts com.footballpredictions.covidappkenya:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy com.footballpredictions.covidappkenya:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout com.footballpredictions.covidappkenya:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage com.footballpredictions.covidappkenya:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery com.footballpredictions.covidappkenya:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.footballpredictions.covidappkenya:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.footballpredictions.covidappkenya:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name com.footballpredictions.covidappkenya:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name com.footballpredictions.covidappkenya:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.footballpredictions.covidappkenya:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.footballpredictions.covidappkenya:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font com.footballpredictions.covidappkenya:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle com.footballpredictions.covidappkenya:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings com.footballpredictions.covidappkenya:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight com.footballpredictions.covidappkenya:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex com.footballpredictions.covidappkenya:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.footballpredictions.covidappkenya:font
     */
     ...
     * </table>
     *
     * @attr name com.footballpredictions.covidappkenya:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.footballpredictions.covidappkenya:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.footballpredictions.covidappkenya:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.footballpredictions.covidappkenya:ttcIndex
     */
